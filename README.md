# 复旦体育理论考试-自动答题机器 ![收录题目总数](https://img.shields.io/badge/收录题目总数-5740-green.svg) ![最后更新时间](https://img.shields.io/badge/最后更新时间-2018/12/8-blue.svg)
...
* 支持是非题与单选题。
* 截止到2018年12月8日，总共有5194道不重复的是非题、546道不重复的单选题。
