# 复旦体育理论考试-自动答题机器 ![收录题目总数](https://img.shields.io/badge/收录题目总数-5798-green.svg) ![最后更新时间](https://img.shields.io/badge/最后更新时间-2019/5/25-blue.svg)
...
* 支持是非题与单选题。
* 截止到2019年5月25日，总共有5239道不重复的是非题、559道不重复的单选题。
