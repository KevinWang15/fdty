# 复旦体育理论考试-自动答题机器 ![收录题目总数](https://img.shields.io/badge/收录题目总数-6149-green.svg) ![最后更新时间](https://img.shields.io/badge/最后更新时间-2020/6/11-blue.svg)
...
* 支持是非题与单选题。
* 截止到2020年6月11日，总共有5419道不重复的是非题、730道不重复的单选题。
